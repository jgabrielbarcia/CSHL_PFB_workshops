...
if [ ! -e ./ecoli.ms16.histogram ] ; then
  ...
  && \
  mv ./ecoli.ms16.histogram.WORKING ./ecoli.ms16.histogram
fi
...
if [ ! -e ./ecoli.ms16.ignore.gz ] ; then
  ...
  totKmers=`/Users/jgabrielbarcia/repo1/genome_assembly_ps/canu-2.2/bin/meryl statistics ./ecoli.ms16 | grep present | awk '{ print $2 }'`
