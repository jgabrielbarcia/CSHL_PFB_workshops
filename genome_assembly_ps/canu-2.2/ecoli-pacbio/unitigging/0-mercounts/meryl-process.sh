...
bin="/Users/jgabrielbarcia/repo1/genome_assembly_ps/canu-2.2/bin"
...
if [ $exists1 = true -a $exists2 = true -a $exists3 = true ] ; then
  echo "Output files 'ecoli.ms22.histogram', 'ecoli.ms22.dump' and 'ecoli.ms22.ignore.gz' exist in 'unitigging/0-mercounts'."
  exit 0
fi
...
if [ ! -e ./ecoli.ms22/merylIndex ] ; then
  /Users/jgabrielbarcia/repo1/genome_assembly_ps/canu-2.2/bin/meryl threads=3 memory=2 \
    greater-than 1 \
...
if [ ! -e ./ecoli.ms22.histogram ] ; then
  /Users/jgabrielbarcia/repo1/genome_assembly_ps/canu-2.2/bin/meryl threads=1 memory=1 \
...
if [ ! -e ./ecoli.ms22.ignore.gz ] ; then
  ...
  totKmers=`/Users/jgabrielbarcia/repo1/genome_assembly_ps/canu-2.2/bin/meryl statistics ./ecoli.ms22 | grep present | awk '{ print $2 }'`
